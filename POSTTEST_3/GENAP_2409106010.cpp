...
void sisipJadwal(string tujuan, string status, int posisi)
{
    ...
    else if (posisi == panjang + 1) // sisip di akhir
    {
        baru->next = nullptr;
        baru->prev = tail;
        if (tail != nullptr)
...
|/       (_______/\_______/(_______)|/     \|   )_(     \_______)(_______/|/     \|(_______/(______/ (_______)(_______/(_______/
        ...
        cout << "8. Tampilkan Semua Jadwal Terbalik\n";
        cout << "9. Tampilkan Jadwal Spesifik\n";
        cout << "0. Keluar\n";
        cout << "Pilih menu: ";
        cin >> pilihan;
        cin.ignore();
        ...
        {
            cout << "==================================================\n";
            cout << "|       DAFTAR JADWAL PENERBANGAN TERBALIK       |\n";
            cout << "==================================================\n";
            tampilkanBalik();
            cout << "Tekan Enter untuk melanjutkan...";
            cin.get();
        ...
        {
            cout << "==================================================\n";
            cout << "|            DETAIL JADWAL PENERBANGAN           |\n";
            cout << "==================================================\n";
            string kode;
            detailJadwal(kode);
            cout << "Tekan Enter untuk melanjutkan...";
